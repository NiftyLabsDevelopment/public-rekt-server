...
export interface DelegateCashInterface extends utils.Interface {
  functions: {
...
export interface DelegateCash extends BaseContract {
  ...
  functions: {
    ...
    getContractLevelDelegations(
      ...
      [IDelegationRegistry.ContractDelegationStructOutput[]] & {
        contractDelegations: IDelegationRegistry.ContractDelegationStructOutput[];
      }
    >;
    ...
    getDelegatesForAll(
      vault: PromiseOrValue<string>,
      overrides?: CallOverrides
    ): Promise<[string[]] & { delegates: string[] }>;
    ...
    getDelegationsByDelegate(
      ...
      [IDelegationRegistry.DelegationInfoStructOutput[]] & {
        info: IDelegationRegistry.DelegationInfoStructOutput[];
      }
    >;
    ...
    getTokenLevelDelegations(
      ...
      [IDelegationRegistry.TokenDelegationStructOutput[]] & {
        tokenDelegations: IDelegationRegistry.TokenDelegationStructOutput[];
      }
    >;
