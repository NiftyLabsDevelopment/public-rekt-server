...
import type { DelegateCash, DelegateCashInterface } from "../DelegateCash";
...
export class DelegateCash__factory {
  static readonly abi = _abi;
  static createInterface(): DelegateCashInterface {
    return new utils.Interface(_abi) as DelegateCashInterface;
  }
  static connect(
    address: string,
    signerOrProvider: Signer | Provider
  ): DelegateCash {
    return new Contract(address, _abi, signerOrProvider) as DelegateCash;
  }
}
